...
class SplitterMetricTreeAppTests(unittest.TestCase):
    ...
    def test_static_rules_d3_poc_page_is_interactive_demo(self) -> None:
        ...
        self.assertIn("Potential subrules produced by mining", html)
        self.assertIn("Use this as diagnostic model data", html)
    ...
    def test_static_action_rule_graph_poc_page_uses_actions_as_nodes(self) -> None:
        html = (REPO_ROOT / "docs" / "action-rule-graph-poc.html").read_text()
        app_source = (REPO_ROOT / "scripts" / "splitter_metric_tree_app.py").read_text()

        self.assertIn("<title>Action Rule Graph POC</title>", html)
        self.assertIn("actions are nodes, rules are edges, tags are metadata chips", html)
        self.assertIn("const fallbackGraph", html)
        self.assertIn("actions:", html)
        self.assertIn("rules:", html)
        self.assertIn("policies:", html)
        self.assertIn("diagnostics:", html)
        self.assertIn("function graphFromRulesPayload", html)
        self.assertIn("function actionForRuleItem", html)
        self.assertIn("function addSubruleEdges", html)
        self.assertIn("function addRuleEdge", html)
        self.assertIn("function roleDefinition", html)
        self.assertIn("function taskForTag", html)
        self.assertIn("subrule-before", html)
        self.assertIn("subrule-after", html)
        self.assertIn("subrule.examples", html)
        self.assertIn("support: subrule.support", html)
        self.assertIn("confidence: subrule.confidence", html)
        self.assertIn("function metricPills", html)
        self.assertIn("function examplesBlock", html)
        self.assertIn("fetch(\"/api/splitter-rules\"", html)
        self.assertIn("tag-chip", html)
        self.assertIn("task-group", html)
        self.assertIn("rule-edge", html)
        self.assertIn("tag:foundation", html)
        self.assertIn("Add foundation structure", html)
        self.assertIn("tag:behavior", html)
        self.assertIn("Implement behavior", html)
        self.assertIn("activate-one-surface-at-a-time", html)
        self.assertIn("Split matching actions independently instead of rendering this as an edge", html)
        self.assertIn("uncategorized-subrules", html)
        self.assertIn("action-rule-graph-poc.html", app_source)
        self.assertIn("DEFAULT_ACTION_RULE_GRAPH_POC_STATIC_PATH", app_source)
