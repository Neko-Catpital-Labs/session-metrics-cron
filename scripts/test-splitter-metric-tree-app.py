...
class SplitterMetricTreeAppTests(unittest.TestCase):
    ...
    def test_fixing_and_explorer_dashboards_include_new_sections(self) -> None:
        ...
        self.assertIn('class=\"chunk-body\" data-chunk-index="${index}" ${isActive ? \'\' : \'hidden\'}>${isActive ? renderChunkBody(chunk) : \'\'}', explorer_html)
        ...
        self.assertIn("setSelectedChunk(selectedChunkIndex === chunkIndex ? -1 : chunkIndex);", explorer_html)
